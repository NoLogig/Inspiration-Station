...
export class CanvasPaintToolsService {
  ...
  draw = {
    ...
    point(ctx: CanvasRenderingContext2D, x: number, y: number): void {
    ...
    line(ctx: CanvasRenderingContext2D, p1: IPoint, p2: IPoint): void {
    ...
    rect(ctx: CanvasRenderingContext2D, shape: IRectPoint): void {
    ...
    circle(ctx: CanvasRenderingContext2D, shape: ICirclePoint): void {
    ...
    hexagon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
    ...
    canvasCenter(ctx: CanvasRenderingContext2D, strokeStyle = '#f3f') {
